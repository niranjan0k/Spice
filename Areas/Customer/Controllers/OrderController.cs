...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderHistory(int productPage = 1)
        {
            ...
            OrderListViewModel ordersListVM = new OrderListViewModel()
            {
            ...
            foreach (OrderHeader order in orderHeadersList)
            {
                OrderDetailsViewModel orderDetailsViewModel = new OrderDetailsViewModel()
                {
                    OrderHeader = order,
                ...
                ordersListVM.Orders.Add(orderDetailsViewModel);
            }
            var count = ordersListVM.Orders.Count;
            ordersListVM.Orders = ordersListVM.Orders.OrderByDescending(o => o.OrderHeader.Id)
                                                    .Skip((productPage - 1) * PageSize)
                                                    .Take(PageSize).ToList();
            ordersListVM.PagingInfo = new PagingInfo()
            {
            ...
            if (searchName != null || searchEmail != null || searchPhone != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            OrderHeaderList = await _db.OrderHeader.Include(o => o.ApplicationUser)
                                                        .Where(u => u.MobileNumber.Contains(searchPhone))
                                                        .OrderByDescending(o => o.OrderDate).ToListAsync();
                        }
                    }
                }
