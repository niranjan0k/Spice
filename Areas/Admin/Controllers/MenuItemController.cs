...
namespace Spice.Areas.Admin.Controllers
{
    ...
    public class MenuItemController : Controller
    {
        ...
        {
            MenuItem menuItem = await _db.MenuItem.Include(m => m.Category).Include(m => m.SubCategory).SingleOrDefaultAsync(m => m.Id == id);
            if (menuItem == null)
            {
                return NotFound();
            }
            ...
            //Delete the original file
            var imagePath = Path.Combine(_hostingEnvironment.WebRootPath, menuItem.Image.TrimStart('\\'));
