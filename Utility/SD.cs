    ...
    public class SD
    {
        ...
        public static double DiscountedPrice(Coupon couponFromDb, double OriginalOrderTotal)
        {
            ...
            else
            {
                ...
                {
                    //everything is valid
                    if (Convert.ToInt32(couponFromDb.CouponType) == (int)Coupon.ECouponType.Rupee)
                    {
                        //₹10 off ₹100
        ...
        public static string MoneyINR(double amount)
        {
            CultureInfo hindi = new CultureInfo("hi-IN");
            return string.Format(hindi, "{0:c}", amount);
        }
